...
namespace DevIO.Api.V1.Controllers
{
    ...
    public class ProdutosController : MainController
    {
        ...
        {
            var fornecedorViewModel = await ObterProduto(id);
        ...
        // imagem mais pesada por IFormFile e não por base 64
        [HttpPost("imagem")]
        ...
        // por enquanto grava a imagem na api
